            ...
            <FlexContainerAlt responsivealign="center" fullWidthChild>
                <motion.div variants={fadeInLeftVariant} initial="hidden" whileInView="visible">
                    ...
                    <ParaText as="p" top="1.5rem" bottom="2.5rem" responsivealign="center">
                        I have completed numerous training projects and attended a variety
                        of courses, working with different frameworks. I am a quick learner
                        with strong research skills and the ability to collaborate effectively
