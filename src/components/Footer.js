...
const FooterComponent = () => {
    return (
        <Footer>
            <Socials>
                <a href="https://wa.me/963997791807"><FaWhatsapp /></a>
                <a href="mailto:ibrahimdayoub619@gmail.com"><FaEnvelope /></a>
            ...
            <Copyright>
                © {new Date().getFullYear()} Ibrahim Dayoub. All rights reserved.
            </Copyright>
        </Footer>
    );
};
