...
import { FaGithub, FaLink, FaPlay, FaMagic, FaBriefcase, FaDownload } from 'react-icons/fa';
...
const Project = ({ project, index, $rowreverse }) => {
    return (
        <FlexContainer $responsiveflex={true} $responsivedirection="column-reverse" $rowreverse={$rowreverse ? true : false} $fullwidthchild>
                    ...
                    <FlexContainer $responsivegap="0.35rem" $gap="0.5rem" $responsiveflex $responsivejustify="center" style={{ flexWrap: "wrap" }}>
                        {
                            project.source_code ?
                                <ButtonAlt2 href={project.source_code} target='_blank' $setmxauto_ style={{ marginTop: "1rem", display: "flex", gap: "5px", alignItems: "center", textDecoration: "none" }}>
                                    ...
                                    <IconContainer $color="white" $responsivesize="0.75rem" $size="1rem"><FaGithub /></IconContainer>
                                </ButtonAlt2> :
                                null
                        }
                        {
                            project.live_link ?
                                <ButtonAlt2 href={project.live_link} target='_blank' $setmxauto_ style={{ marginTop: "1rem", display: "flex", gap: "5px", alignItems: "center", textDecoration: "none" }}>
                                    ...
                                    <IconContainer $color="white" $responsivesize="0.75rem" $size="1rem"><FaLink /></IconContainer>
                                </ButtonAlt2> :
                                null
                        }
                        {
                            project.download_link ?
                                <ButtonAlt2 href={project.download_link} target='_blank' $setmxauto_ style={{ marginTop: "1rem", display: "flex", gap: "5px", alignItems: "center", textDecoration: "none" }}>
                                    <span style={{ marginRight: "5px" }}>Download</span>
                                    <IconContainer $color="white" $responsivesize="0.75rem" $size="1rem"><FaDownload /></IconContainer>
                                </ButtonAlt2> :
                                null
                        }
                        {
                            project.related_link ?
                                <ButtonAlt2 href={project.related_link} target='_blank' $setmxauto_ style={{ marginTop: "1rem", display: "flex", gap: "5px", alignItems: "center", textDecoration: "none" }}>
                                    ...
                                    <IconContainer $color="white" $responsivesize="0.75rem" $size="1rem"><FaMagic /></IconContainer>
                                </ButtonAlt2> :
                                null
                        }
                        {
                            project.demo_link ?
                                <ButtonAlt2 href={project.demo_link} target='_blank' $setmxauto_ style={{ marginTop: "1rem", display: "flex", gap: "5px", alignItems: "center", textDecoration: "none" }}>
                                    ...
                                    <IconContainer $color="white" $responsivesize="0.75rem" $size="1rem"><FaPlay /></IconContainer>
                                </ButtonAlt2> :
                                null
                        }
                    </FlexContainer>
